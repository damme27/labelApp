			...
			<form method="post" id="departmentForm">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title"><i class="fa fa-plus"></i> Add New Label Type</h4>
					</div>
					<div class="modal-body">
						<div class="form-group"
							<label for="department" class="control-label">Label Type Name</label>
							<input type="text" class="form-control" id="department" name="department" placeholder="Die Cut" required>			
						</div>
						<div class="form-group">
